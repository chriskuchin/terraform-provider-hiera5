...
var primitivePTypes = map[reflect.Kind]dgo.Type{
	...
	reflect.Int8:    Integer64Type(math.MinInt8, math.MaxInt8, true),
	reflect.Int16:   Integer64Type(math.MinInt16, math.MaxInt16, true),
	reflect.Int32:   Integer64Type(math.MinInt32, math.MaxInt32, true),
	reflect.Int64:   DefaultIntegerType,
	reflect.Uint:    Integer64Type(0, math.MaxInt64, true),
	reflect.Uint8:   Integer64Type(0, math.MaxUint8, true),
	reflect.Uint16:  Integer64Type(0, math.MaxUint16, true),
	reflect.Uint32:  Integer64Type(0, math.MaxUint32, true),
	reflect.Uint64:  Integer64Type(0, math.MaxInt64, true),
	reflect.Float32: Float64Type(-math.MaxFloat32, math.MaxFloat32, true),
